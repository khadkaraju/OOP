...
HW2
Part 2
 * Asks for the shape of polygon 
 and calculates the area of that polygon
...
public class Area {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please Enter The Shape Whose Area You Want To Be Calculated. "); //asks to enter the name of polynomial
        ...
        }else if(s.equals("circle")) //if condition when user inputs the circle
        {
            ...
            System.out.println("NOT VALID!!! \nPlease Enter The Valid Polygon!!! "); //displays error if the user enter different polygon except these three
        }
        input1.close();
    }
}